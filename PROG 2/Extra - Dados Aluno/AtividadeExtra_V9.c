...
typedef struct {
    ...
    char matricula[20];
    int periodo;
    float notas[5][2];  // notas[disciplina][0] -> nota1, notas[disciplina][1] -> nota2
    float media_final[TAM_DISCIPLINAS];
    char situacao[TAM_DISCIPLINAS][20]; // Situação por disciplina
} Aluno;
